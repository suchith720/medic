...
if __name__ == '__main__':
    ...
    # output_dir = '/home/aiscuser/scratch1/outputs/medic/05_extreme-classifiers-003'
    ...
    m_student = CLS001(DistilBertConfig(), n_train=block.train.dset.n_data, n_test=block.test.dset.n_data, n_lbl=block.n_lbl, batch_size=bsz, 
            num_batch_labels=5000, margin=0.3, num_negatives=10, tau=0.1, apply_softmax=True)

    """ Distillation model """
    mname = f'{output_dir}/{os.path.basename(get_best_model(output_dir))}'
    model = DTL006.from_pretrained(mname, m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
    ...
    learn.model.m_student.perform_train_inference = True
