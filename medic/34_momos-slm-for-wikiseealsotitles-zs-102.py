...
os.environ['WANDB_PROJECT']='medic_07-slm-wikiseealsotitles'
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/34_momos-slm-for-wikiseealsotitles-zs-102'
    teacher_output = '/data/to_b/llm_embed/llama_last_token_zs.pt'
    ...
    o = torch.pca_lowrank(data_embed, q=config.dim, center=True, niter=10)
    data_embed = o[0].contiguous()
