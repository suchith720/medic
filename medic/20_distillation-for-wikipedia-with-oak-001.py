# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/19_distillation-for-wikiseealso-with-oak.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/19_distillation-for-wikiseealso-with-oak.ipynb 2
...
# %% ../nbs/19_distillation-for-wikiseealso-with-oak.ipynb 4
...
# %% ../nbs/19_distillation-for-wikiseealso-with-oak.ipynb 6
if __name__ == '__main__':
    build_block = True
    data_dir = '/data/datasets'
    pkl_dir = '/home/aiscuser/scratch1/datasets/'

    output_dir = '/home/aiscuser/scratch1/outputs/medic/20_distillation-for-wikipedia-with-oak-001'
    ...
    """ Load data """
    pkl_file = f'{pkl_dir}/processed/wikipedia_data-lnk_distilbert-base-uncased_xcs.pkl'

    if build_block:
        
        block = XCBlock.from_cfg(data_dir, 'data_lnk', dset='wikipedia', transform_type='xcs', tokenizer='distilbert-base-uncased', 
                                 sampling_features=[('lbl2data',4), ('lnk2data',3)], oversample=False, max_sequence_length=128)
