...
if __name__ == '__main__':
    ...
    teacher_dir = '/data/Projects/xc_nlg/outputs/94-ngame-ep-for-wikiseealso-with-input-concatenation-5-1/'
    representation_dir = '/data/Projects/outputs/medic/19_distillation-for-wikiseealso-with-oak-001/'

    output_dir = '/home/aiscuser/scratch1/outputs/medic/05_extreme-classifiers-202'
