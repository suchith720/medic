...
if __name__ == '__main__':
    ...
    model_output = '/home/aiscuser/scratch1/outputs/medic/11_ngame-for-wikiseealso-with-input-concatenation-001/'
    meta_embed_file = '/data/OGB_Weights/LF-WikiSeeAlso-320K/emb_weights.npy'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/wikiseealso_data-lnk_distilbert-base-uncased_xcs_256.pkl'

    if build_block:
        
        block = XCBlock.from_cfg(data_dir, 'data_lnk', dset='wikiseealso', transform_type='xcs', tokenizer='distilbert-base-uncased', 
                                 sampling_features=[('lbl2data',4), ('lnk2data',3)], oversample=False, max_sequence_length=256)
