...
def threshold_meta_dataset(train_meta, test_meta, thresh=100):
    ...
    return get_meta_dataset(train_meta, idx), get_meta_dataset(test_meta, idx), idx
...
if __name__ == '__main__':
    ...
    fname = '/home/aiscuser/scratch1/outputs/medic/23_ngame-linker-for-wikiseealsotitles-001/linker/train_predictions.pkl'
    with open(fname, 'rb') as file: o = pickle.load(file)
    data_meta = get_pred_sparse(o, block.train.dset.meta['cat_meta'].n_meta)

    meta_data = data_meta.T.tocsr()
    for row_num in idx:
    ...
    block.train.dset.meta.cat_meta.update_meta_matrix(data_meta, lbl_meta)

    fname = '/home/aiscuser/scratch1/outputs/medic/23_ngame-linker-for-wikiseealsotitles-001/linker/test_predictions.pkl'
    with open(fname, 'rb') as file: o = pickle.load(file)
    ...
    block.collator.tfms.tfms[0].sampling_features = [('lbl2data',4),('cat2data',3)]
