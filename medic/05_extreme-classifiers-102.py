...
if __name__ == '__main__':
    ...
    representation_dir = '/data/Projects/outputs/medic/04_distillation-for-wikititles-with-oak-004'

    output_dir = '/home/aiscuser/scratch1/outputs/medic/05_extreme-classifiers-102'
