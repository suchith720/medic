...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/19_distillation-for-wikiseealso-with-oak-001'
    model_output = '/data/Projects/xc_nlg/outputs/94-ngame-ep-for-wikiseealso-with-input-concatenation-5-1/'
    meta_embed_file = '/data/OGB_Weights/LF-WikiSeeAlso-320K/emb_weights.npy'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/wikiseealso_data-lnk_distilbert-base-uncased_xcs.pkl'
