# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_ngame-for-wikititles-with-input-concatenation.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/03_ngame-for-wikititles-with-input-concatenation.ipynb 2
import os,torch, torch.multiprocessing as mp, pickle, numpy as np
from xcai.basics import *
from xcai.models.PPP0XX import DBT009,DBT011

# %% ../nbs/03_ngame-for-wikititles-with-input-concatenation.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='medic_01-wikititles'

# %% ../nbs/03_ngame-for-wikititles-with-input-concatenation.ipynb 6
if __name__ == '__main__':
    ...
    args = XCLearningArguments(
        output_dir='/home/scai/phd/aiz218323/scratch/outputs/medic/03_ngame-for-wikititles-with-input-concatenation',
