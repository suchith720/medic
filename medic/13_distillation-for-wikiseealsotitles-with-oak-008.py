...
from xcai.models.distillation import DTL010,TCH001,TCH002
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/13_distillation-for-wikiseealsotitles-with-oak-008'
    ...
    """ Distillation model """
    model = DTL010(DistilBertConfig(), m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
                   n_negatives=10, apply_softmax=True, student_loss_weight=1.0, teacher_data_student_label_loss_weight=1.0, 
