# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/08_distillation-with-oak-inference.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/08_distillation-with-oak-inference.ipynb 2
...
from xcai.models.distillation import DTL005, TCH003, TCH001
...
# %% ../nbs/08_distillation-with-oak-inference.ipynb 3
os.environ['WANDB_MODE'] = 'disabled'
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'

# %% ../nbs/08_distillation-with-oak-inference.ipynb 5
if __name__ == '__main__':
    ...
    m_teacher = TCH001.from_pretrained(f'{model_output}/teacher', n_data=block.train.dset.n_data)
    ...
    test_o = learn.predict(block.test.dset)
    print(test_o.metrics)
    ...
    if args.use_centroid_label_representation:
        ...
        train_o = learn.predict(block.train.dset)
        print(train_o.metrics)
        ...
        with open(train_pred_file, 'wb') as file: pickle.dump(train_o, file)
            
    with open(test_pred_file, 'wb') as file: pickle.dump(test_o, file)
