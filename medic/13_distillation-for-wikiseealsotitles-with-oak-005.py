...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/13_distillation-for-wikiseealsotitles-with-oak-005'
    ...
    if build_block:
        block = XCBlock.from_cfg(data_dir, 'data-lnk', transform_type='xcs', tokenizer='distilbert-base-uncased', 
    ...
    """ preparing linker """
    fname = '/home/aiscuser/scratch1/outputs/medic/23_ngame-linker-for-wikiseealsotitles-005/linker/train_predictions.pkl'
    with open(fname, 'rb') as file: o = pickle.load(file)
    data_meta = get_pred_sparse(o, block.train.dset.meta['lnk_meta'].n_meta)
    ...
    fname = '/home/aiscuser/scratch1/outputs/medic/23_ngame-linker-for-wikiseealsotitles-005/linker/test_predictions.pkl'
    with open(fname, 'rb') as file: o = pickle.load(file)
    data_meta = get_pred_sparse(o, block.test.dset.meta['lnk_meta'].n_meta)
