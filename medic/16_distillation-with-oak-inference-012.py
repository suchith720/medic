# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_distillation-for-wikititles-with-oak.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/04_distillation-for-wikititles-with-oak.ipynb 2
...
# %% ../nbs/04_distillation-for-wikititles-with-oak.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '12,13'
os.environ['WANDB_MODE'] = 'disabled'

# %% ../nbs/04_distillation-for-wikititles-with-oak.ipynb 6
@patch
...
if __name__ == '__main__':
    ...
    output_dir = '/data/Projects/outputs/medic/04_distillation-for-wikititles-with-oak-004'
    ...
    """ Load data """
    pkl_file = f'{pkl_dir}/processed/{dataset_name}_data-meta_distilbert-base-uncased_xcs.pkl'

    if build_block:
        block = XCBlock.from_cfg(data_dir, 'data_meta', dset=dataset_name, transform_type='xcs', tokenizer='distilbert-base-uncased', 
                                 sampling_features=[('lbl2data',4), ('hlk2data',3)], oversample=True)
        with open(pkl_file, 'wb') as file: pickle.dump(block, file)
    else:
        with open(pkl_file, 'rb') as file: block = pickle.load(file)

    """ Prune metadata """
    data_meta = retain_topk(block.train.dset.meta.hlk_meta.data_meta, k=5)
    lbl_meta = block.train.dset.meta.hlk_meta.lbl_meta
    block.train.dset.meta.hlk_meta.update_meta_matrix(data_meta, lbl_meta)
    
    data_meta = retain_topk(block.test.dset.meta.hlk_meta.data_meta, k=3)
    lbl_meta = block.test.dset.meta.hlk_meta.lbl_meta
    block.test.dset.meta.hlk_meta.update_meta_matrix(data_meta, lbl_meta)

    block.collator.tfms.tfms[0].sampling_features = [('lbl2data',1),('hlk2data',5)]
    block.collator.tfms.tfms[0].oversample = False
    
    block.train.dset.meta.hlk_meta.meta_info = None
    block.test.dset.meta.hlk_meta.meta_info = None
    ...
    args = XCLearningArguments(
        ...
        label_names=['lbl2data_idx', 'lbl2data_input_ids', 'lbl2data_attention_mask', 'hlk2data_idx'],
        
        prune_metadata=False,
        num_metadata_prune_warmup_epochs=10,
        num_metadata_prune_epochs=5,
        metadata_prune_batch_size=2048,
        prune_metadata_names=['hlk_meta'],
    ...
    m_student = OAK001.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', batch_size=bsz, num_batch_labels=5000, 
                                       ...
                                       data_aug_meta_prefix='hlk2data', lbl2data_aug_meta_prefix=None, 
                                       data_pred_meta_prefix=None, lbl2data_pred_meta_prefix=None,
                                       
                                       num_metadata=block.train.dset.meta['hlk_meta'].n_meta, resize_length=5000,
    ...
    model = DTL005.from_pretrained(mname, m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
            n_negatives=10, apply_softmax=True, teacher_data_student_label_loss_weight=0.1, data_mse_loss_weight=0.0)
