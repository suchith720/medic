...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/36_oak-for-wikiseealsotitles-free-param-clustering-002'
    ...
    meta_remap, n_clusters = get_metadata_remap(meta_embeddings, 5)
