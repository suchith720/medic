...
if __name__ == '__main__':
    ...
    if build_block:
        block = XCBlock.from_cfg(data_dir, 'data_cat_lnk', dset=dataset_name, transform_type='xcs', tokenizer='distilbert-base-uncased', 
    ...
    """ datapoint without ground truth metadata """
    data_meta = block.test.dset.meta['cat_meta'].data_meta
    idx = np.where(data_meta.getnnz(axis=1) == 0)[0]

    data_meta = retain_topk(block.test.dset.meta.lnk_meta.data_meta, k=3)
    for row_num in idx:
        a = data_meta.indptr[row_num]
        b = data_meta.indptr[row_num+1]
        data_meta.data[a:b] = 0
