...
if __name__ == '__main__':
    ...
    teacher_dir = '/data/Projects/outputs/medic/11_ngame-for-wikiseealso-with-input-concatenation-001'
    representation_dir = '/home/aiscuser/scratch1/outputs/medic/19_distillation-for-wikiseealso-with-oak-002/'

    output_dir = '/home/aiscuser/scratch1/outputs/medic/05_extreme-classifiers-203'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/wikiseealso_data_distilbert-base-uncased_xcs_256.pkl'

    if build_block:
        block = XCBlock.from_cfg(data_dir, 'data', dset=dataset_type, transform_type='xcs', tokenizer='distilbert-base-uncased', 
                                 sampling_features=[('lbl2data',4)], oversample=False, max_sequence_length=256)
    ...
    m_student = CLS001.from_pretrained(f'{representation_dir}/representation', n_train=block.train.dset.n_data, 
    ...
    model = DTL006(DistilBertConfig(), m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
                   ...
                   student_data_teacher_label_loss_weight=0.0, data_mse_loss_weight=0.0, label_mse_loss_weight=0.1)
