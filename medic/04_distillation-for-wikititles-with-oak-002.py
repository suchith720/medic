...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/14_distillation-for-wikititles-with-oak-002'
    model_output = '/data/Projects/xc_nlg/outputs/93-ngame-ep-for-wikititles-with-input-concatenation-5-0'
    meta_embed_file = '/data/OGB_Weights/LF-WikiTitles-500K/embs_weight.npy'
