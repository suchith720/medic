...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/34_momos-slm-for-wikiseealsotitles-203'
    teacher_output = '/data/to_b/llm_embed/mistral_last_tok.pth'
    ...
    m_teacher = TCH004(config, n_data=block.train.dset.n_data, embed_dim=data_embed.shape[1])
