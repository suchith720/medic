...
os.environ['CUDA_VISIBLE_DEVICES'] = '2,3,6,7,8,9'
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/26_distillation-for-wikipedia-with-oak-002'
    model_output = '/data/Projects/outputs/medic/12_ngame-for-wikipedia-with-input-concatenation-001/'
    meta_embed_file = '/data/OGB_Weights/LF-Wikipedia-500K/embs_weight.npy'

    """ Load data """
    pkl_dir = '/home/aiscuser/scratch1/datasets/'
    pkl_file = f'{pkl_dir}/processed/wikipedia_data-lnk_distilbert-base-uncased_xcs_128.pkl'

    if build_block:
        block = XCBlock.from_cfg(data_dir, 'data_lnk', dset='wikipedia', transform_type='xcs', tokenizer='distilbert-base-uncased', 
                                 sampling_features=[('lbl2data',1), ('lnk2data',3)], oversample=False, max_sequence_length=128)
