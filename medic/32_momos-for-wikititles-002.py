...
if __name__ == '__main__':
    ...
    """ Load data """
    pkl_file = f'{pkl_dir}/processed/wikititles_data-lnk_distilbert-base-uncased_oak.pkl'

    if build_block:
        block = XCBlock.from_cfg(data_dir, 'data_lnk', dset='wikititles', transform_type='oak', tokenizer='distilbert-base-uncased',
                padding=True, return_tensors='pt', num_labels=1, num_metadata=3, metadata_name='lnk')
