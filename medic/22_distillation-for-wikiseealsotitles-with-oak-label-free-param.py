# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/22_distillation-for-wikiseealsotitles-with-oak-label-free-param.ipynb.

# %% auto 0
__all__ = ['get_label_representation']

# %% ../nbs/22_distillation-for-wikiseealsotitles-with-oak-label-free-param.ipynb 2
import os,torch, torch.multiprocessing as mp, pickle, numpy as np
from transformers import DistilBertConfig

from xcai.basics import *
from xcai.models.oak import OAK007
...
# %% ../nbs/22_distillation-for-wikiseealsotitles-with-oak-label-free-param.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='medic_00-wikiseealsotitles'

# %% ../nbs/22_distillation-for-wikiseealsotitles-with-oak-label-free-param.ipynb 6
def get_label_representation(
    ...
    **kwargs
    ...
    self.m_student.get_label_representation(data_idx, data_input_ids, data_attention_mask, **kwargs)
    

# %% ../nbs/22_distillation-for-wikiseealsotitles-with-oak-label-free-param.ipynb 7
if __name__ == '__main__':
    build_block = False
    pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets/'
    data_dir = '/home/scai/phd/aiz218323/Projects/XC_NLG/data'
    
    output_dir = '/home/scai/phd/aiz218323/scratch/outputs/medic/22_distillation-for-wikiseealsotitles-with-oak'
    ...
    m_student = OAK007.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', batch_size=bsz, num_batch_labels=5000,
                                       ...
                                       num_metadata=block.train.dset.meta['lnk_meta'].n_meta, n_labels=block.n_lbl, resize_length=5000,
