...
if __name__ == '__main__':
    ...
    representation_dir = '/data/Projects/xc_nlg/outputs/86-distillation-for-wikiseealso-with-oak-7-3-4'
    ...
    model = DTL006(DistilBertConfig(), m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
                   ...
                   student_data_teacher_label_loss_weight=0.0, data_mse_loss_weight=0.0, label_mse_loss_weight=1.0)
