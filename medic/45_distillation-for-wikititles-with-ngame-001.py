# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/45_distillation-for-wikititles-with-ngame.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/45_distillation-for-wikititles-with-ngame.ipynb 2
...
# %% ../nbs/45_distillation-for-wikititles-with-ngame.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '10,11'
os.environ['WANDB_PROJECT']='medic_01-wikititles'

# %% ../nbs/45_distillation-for-wikititles-with-ngame.ipynb 6
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/45_distillation-for-wikititles-with-ngame-001'
    teacher_dir = '/data/Projects/xc_nlg/outputs/93-ngame-ep-for-wikititles-with-input-concatenation-5-0'
    ...
    m_student = DBT009.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
                                       n_negatives=10, apply_softmax=True, use_encoder_parallel=True)
    m_student.init_dr_head()

    """ Distillation model """
    model = DTL007(DistilBertConfig(), m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
