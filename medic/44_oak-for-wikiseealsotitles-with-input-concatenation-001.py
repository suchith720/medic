# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/44_oak-for-wikiseealsotitles-with-input-concatenation.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/44_oak-for-wikiseealsotitles-with-input-concatenation.ipynb 2
...
# %% ../nbs/44_oak-for-wikiseealsotitles-with-input-concatenation.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '6,7'
os.environ['WANDB_PROJECT']='medic_11-iclr-2025'

# %% ../nbs/44_oak-for-wikiseealsotitles-with-input-concatenation.ipynb 6
if __name__ == '__main__':
    build_block = False
    data_dir = '/data/datasets/'
    pkl_dir = '/home/aiscuser/scratch1/datasets/'
    
    output_dir = '/home/aiscuser/scratch1/outputs/medic/44_oak-for-wikiseealsotitles-with-input-concatenation'
    meta_embed_file = '/data/OGB_Weights/LF-WikiSeeAlsoTitles-320K/emb_weights.npy'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/wikiseealsotitles_data-lnk_distilbert-base-uncased_xcs_lnk-128.pkl'
    if build_block:
        ...
        block = AugmentMetaInputIdsTfm.apply(block, 'lnk_meta', 'lbl', 128, True)
    ...
    block.train.dset.data.lbl_info['input_ids'] = block.train.dset.data.lbl_info['input_ids_aug_lnk']
    block.train.dset.data.lbl_info['attention_mask'] = block.train.dset.data.lbl_info['attention_mask_aug_lnk']
    block.test.dset.data.lbl_info['input_ids'] = block.test.dset.data.lbl_info['input_ids_aug_lnk']
    block.test.dset.data.lbl_info['attention_mask'] = block.test.dset.data.lbl_info['attention_mask_aug_lnk']
