...
from xcai.models.distillation import DTL005, TCH003, TCH001, DTL004
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/04_distillation-for-wikititles-with-oak-005'
    ...
    """ Teacher model """
    model_output = '/data/Projects/xc_nlg/outputs/93-ngame-ep-for-wikititles-with-input-concatenation-5-0'
    ...
    """ Distillation model """
    mname = f'{output_dir}/checkpoint-340200'
    ...
    model = DTL004.from_pretrained(mname, m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
            n_negatives=10, apply_softmax=True, teacher_data_student_label_loss_weight=1.0, student_data_teacher_label_loss_weight=1.0, 
