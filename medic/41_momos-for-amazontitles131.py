...
# %% ../nbs/41_momos-for-amazontitles.ipynb 7
...
if __name__ == '__main__':
    ...
    output_dir = '/home/scai/phd/aiz218323/scratch/outputs/medic/41_momos-for-amazontitles131'
    model_output = '/home/scai/phd/aiz218323/scratch/outputs/38_ngame-for-amazontitles131-with-input-concatenation'
    meta_embed_file = '/home/aiscuser/scratch/OGB_Weights/LF-AmazonTitles-131K/emb_weights.npy'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/amazontitles131_data-lnk_distilbert-base-uncased_xcs.pkl'

    if build_block:
        block = XCBlock.from_cfg(data_dir, 'data_lnk', dset='amazontitles131', transform_type='xcs', tokenizer='distilbert-base-uncased', 
