...
if __name__ == '__main__':
    ...
    pkl_file = f'{pkl_dir}/processed/wikipedia_data-metas_distilbert-base-uncased_xcs_hlk-350.pkl'

    with open(pkl_file, 'rb') as file: block = pickle.load(file)
    
    """ Training Arguements """
    args = XCLearningArguments(
        output_dir='/home/aiscuser/scratch1/outputs/medic/12_ngame-for-wikipedia-with-input-concatenation-002',
