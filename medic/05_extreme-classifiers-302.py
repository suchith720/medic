...
if __name__ == '__main__':
    ...
    representation_dir = '/data/From_B/medic/33_momos-for-wikipedia-001/'
    ...
    model = CLS001.from_pretrained(f'{representation_dir}/representation', n_train=block.train.dset.n_data, 
